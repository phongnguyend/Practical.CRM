...
static async Task CreateLead(ForceClient forceClient, string token)
{
...
static async Task DownloadPhoto(string token, User owner)
{
...
static async Task UpdateLead(ForceClient forceClient, Lead lead)
{
...
static async Task DeleteLead(ForceClient forceClient, Lead lead)
{
